...
class Crypto implements StreamInterface
{
    ...
    private static function encryptInternal($plaintext, KeyOrPassword $secret, $raw_binary = false)
    {
        ...
        try {
            ...
            self::encryptResourceInternal($input, $output, $secret);
    ...
    private static function decryptInternal($ciphertext, KeyOrPassword $secret, $raw_binary = false)
    {
        if (!$raw_binary) {
            try {
        ...
        try {
            ...
            self::decryptResourceInternal($input, $output, $secret);
    ...
    final public static function getFileStreamSizeAndReset($fh)
    {
